 ...
 */
import type { GitAction, GitActionResult, GitActionRequest, GitQueryRequest, GitQueryResponse, GitSnapshotRequest, GitSnapshotResult, GitStorageReadRequest, GitStorageReadResult, GitStorageWriteRequest, GitStorageWriteResult, GitPresetRequest, GitPresetResult } from '../host/types.ts'
...
export interface GitRemoteLike {
  ...
  /** 获取出厂预设(config.defaultSettings);null = 部署方未提供。 */
  getPreset(request: GitPresetRequest): Promise<RemoteEnvelope<GitPresetResult>>
}
