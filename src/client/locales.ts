...
export const zh = {
  ...
  'work.badge': '最近工作时段的变更（本会话 {internal} · 外部 {external}）',
...
export const en: Record<GitKey, string> = {
  ...
  'work.badge': 'Changes since the latest working period (this session {internal} · external {external})',
  ...
  'work.summaryInternal': 'This session',
