...
export const zh = {
  ...
  'work.reclassify.sibling': '改归其他会话 AI',
  ...
  'history.detailFailed': '提交详情加载失败，请重试',
  'history.branch': '分支',
  'history.allUsers': '全部用户',
  'history.allTime': '全部时间',
  'history.today': '今天',
  'history.last24h': '24 小时内',
  ...
  'diff.badgeNew': '新增',
  'diff.badgeDeleted': '已删除',
  'diff.view': '差异视图',
  'diff.view.split': '对照',
  'diff.view.before': '变更前',
  'diff.view.after': '变更后',
  'diff.view.rendered': '渲染',
  'diff.renderedEmpty': '（无内容可渲染）',
  'diff.mermaid.source': '源码',
  'diff.mermaid.error': '图表解析失败',
  'history.clearSearch': '清除搜索',
  'history.openFileDiff': '在变更页查看该文件在此提交中的变更',
  ...
  'settings.workRecord': '工作记录徽章',
  'settings.workRecord.desc': '会话头部 Pill 上的工作记录徽章（本会话/外部计数与未读提示）',
  'settings.popupWorkRecord': '工作记录区块',
  'settings.popupWorkRecord.desc': '详情弹窗内的工作记录区块（最近工作时段的文件分组与三方归因）',
  ...
  'settings.group.popupOrder': '弹窗区块顺序',
  'settings.popupOrder.note': '头部与底部固定；用箭头调整详情弹窗内各区块的展示顺序，隐藏的区块保留在序列中',
  'settings.popupOrder.hidden': '已隐藏',
  'settings.popupOrder.up': '上移',
  'settings.popupOrder.down': '下移',
  'settings.reset': '恢复预设',
...
export const en: Record<GitKey, string> = {
  ...
  'popup.openCommit': 'View this commit in History',
  ...
  'work.reclassify.sibling': 'Mark as other-session AI',
  ...
  'history.detailFailed': 'Failed to load commit details. Retry.',
  ...
  'diff.view.rendered': 'Rendered',
  'diff.renderedEmpty': '(nothing to render)',
  'diff.mermaid.source': 'Source',
  'diff.mermaid.error': 'Diagram failed to parse',
  'history.clearSearch': 'Clear search',
  'history.openFileDiff': 'View this file\u2019s changes in this commit (Changes tab)',
  ...
  'history.loadFailed': 'Failed to load history — scroll or change filters to retry',
  ...
  'settings.workRecord': 'Work-record badge',
  'settings.workRecord.desc': 'The work-record badge on the session-header pill (this-session/external counts and unread hint)',
  'settings.popupWorkRecord': 'Work-record section',
  'settings.popupWorkRecord.desc': 'The work-record section in the detail popup (file groups of the latest working period and three-way attribution)',
  ...
  'settings.group.popupOrder': 'Popup section order',
  'settings.popupOrder.note': 'Header and footer stay fixed; use the arrows to reorder popup sections — hidden ones stay in the sequence',
  'settings.popupOrder.hidden': 'Hidden',
  'settings.popupOrder.up': 'Move up',
  'settings.popupOrder.down': 'Move down',
