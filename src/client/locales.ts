...
export const zh = {
  ...
  'work.emptyDetails': '该时段内没有产生 Git 变更。打开 Git 中心「记录」标签可查看全部 turn 的历史记录。',
  'work.turnMeta': 'Turn {n} · {time}',
  'work.summaryTurns': '工作轮次',
  'work.summaryExternal': '外部',
  'work.summaryDirty': '仍变更',
  'work.summaryRecentTurn': '最近 Turn',
  'work.changesBadge': '变更 {n}',
  'work.noChanges': '无变更',
  'work.legend.title': '条目状态',
  'work.legendName.dirty': '仍变更',
  'work.legendName.committed': '已提交',
  'work.legendName.reverted': '已还原',
  'work.legendName.gone': '已离开',
  'work.legend.dirty': '当前仍在 Git 工作区变更列表（changes）中',
  'work.legend.committed': '不在工作区，但观测到过「HEAD 前移提交」该路径',
  'work.legend.reverted': '不在工作区，且权威确认从未进入 Git 历史',
  'work.legend.gone': '不在工作区，去向待定（中性态，持续探测）',
  'work.idleRange': 'Turn {from}–{to} · 无工作',
  'work.idleSingle': 'Turn {n} · 无工作',
...
export const en: Record<GitKey, string> = {
  ...
  'work.emptyDetails': 'No Git changes in this period. Open the Records tab in the Git center for the full per-turn history.',
  'work.turnMeta': 'Turn {n} · {time}',
  'work.summaryTurns': 'Working turns',
  'work.summaryExternal': 'External',
  'work.summaryDirty': 'Still dirty',
  'work.summaryRecentTurn': 'Latest turn',
  'work.changesBadge': 'Changed {n}',
  'work.noChanges': 'No changes',
  'work.legend.title': 'Entry states',
  'work.legendName.dirty': 'Dirty',
  'work.legendName.committed': 'Committed',
  'work.legendName.reverted': 'Reverted',
  'work.legendName.gone': 'Left',
  'work.legend.dirty': 'Currently in the Git working-tree changes list',
  'work.legend.committed': 'Left the tree; a HEAD-advancing commit was observed for this path',
  'work.legend.reverted': 'Left the tree; authoritatively confirmed never entered Git history',
  'work.legend.gone': 'Left the tree; final state undetermined (neutral, probing continues)',
  'work.idleRange': 'Turns {from}–{to} · no work',
  'work.idleSingle': 'Turn {n} · no work',
