...
export const zh = {
  ...
  'work.legend.dirty': '仍变更——当前仍在 Git 工作区变更列表（changes）中',
  'work.legend.committed': '已提交——不在工作区，但观测到过「HEAD 前移提交」该路径',
  'work.legend.reverted': '已还原——不在工作区，且权威确认从未进入 Git 历史',
  'work.legend.gone': '已离开工作区——不在工作区，去向待定（中性态，持续探测）',
...
export const en: Record<GitKey, string> = {
  ...
  'work.legend.dirty': 'Dirty — currently in the Git working-tree changes list',
  'work.legend.committed': 'Committed — left the tree, but a HEAD-advancing commit was observed for this path',
  'work.legend.reverted': 'Reverted — left the tree, authoritatively confirmed never entered Git history',
  'work.legend.gone': 'Left working tree — absent from the tree, final state undetermined (neutral, probing continues)',
